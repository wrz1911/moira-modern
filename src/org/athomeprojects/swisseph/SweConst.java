...
* user of the org.athomeprojects.swisseph package.<P>
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  // jimmy: need way to check for return status. SwephData.NOT_AVAILABLE rather than
  // SweConst.ERR is return if seas file is missing
  public static final int NOT_AVAILABLE = SwephData.NOT_AVAILABLE;
...
//////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  static final int SE_NFICT_ELEM=19;
  ...
  */
  ...
  public static final int SEFLG_TRANSIT_LONGITUDE =  128*1024; // calculate transits over a longitude
  public static final int SEFLG_TRANSIT_LATITUDE  =  256*1024; // calculate transits over a latitude
  public static final int SEFLG_TRANSIT_DISTANCE  =  512*1024; // calculate transits over a distance in AU
  public static final int SEFLG_TRANSIT_SPEED     = 1024*1024; // calculate transits over a (longitudinal, latitudinal or distance) speed value
  ...
  */
   ...
   * It is defined as being <CODE>".:./ephe:../ephe"</CODE>.
   * @see SwissEph#swe_set_ephe_path(java.lang.String)
   */
  // jimmy: change search directory
  public static final String SE_EPHE_PATH="ephe:.";
  ...
  * @see org.athomeprojects.swisseph.SwissEph#swe_rise_trans(double, int, java.lang.StringBuffer, int, int, double[], double, double, org.athomeprojects.swisseph.DblObj, java.lang.StringBuffer)
  */
  ...
  * @see org.athomeprojects.swisseph.SwissEph#swe_azalt(double, int, double[], double, double, double[], double[])
  */
  ...
  * long., xout[1]=&nbsp;ecl. lat..
  * @see org.athomeprojects.swisseph.SwissEph#swe_azalt_rev(double, int, double[], double[], double[])
  */
  ...
  * @see org.athomeprojects.swisseph.SwissEph#swe_refrac(double, double, double, int)
  * @see #SE_APP_TO_TRUE
  */
