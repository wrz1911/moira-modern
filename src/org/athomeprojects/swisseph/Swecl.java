...
//      goto iter_where;
  ...
  */
  int swe_sol_eclipse_when_glob(double tjd_start, int ifl, int ifltype,
    ...
    double t, tt, tjd, tjds, tjdsv, dt, dta, dtb;
    ...
    int iflag, iflagtop, iflagcart;
    ifl &= SweConst.SEFLG_EPHMASK;
    iflag = SweConst.SEFLG_EQUATORIAL | ifl;
    iflagtop = SweConst.SEFLG_EQUATORIAL | SweConst.SEFLG_TOPOCTR | ifl;
...
//next_try:
  ...
  int swe_lun_occult_when_glob(
    ...
    while(true) {
//next_try:
      if (calc_planet_star(t, ipl, starname, iflag | SweConst.SEFLG_SPEED, ls, serr) == SweConst.ERR)
        return SweConst.ERR;
      if (sw.swe_calc(t, SweConst.SE_MOON, iflag | SweConst.SEFLG_SPEED, lm, serr) == SweConst.ERR)
        return SweConst.ERR;
      dctr.val = sl.swe_degnorm(ls[0] - lm[0]);
      if (backward!=0)
        dctr.val = 360 - dctr.val;
      dtv = lm[3] - ls[3]; /* difference in speed */
      t = t + direction * dctr.val / dtv;
      if (calc_planet_star(t, ipl, starname, iflag | SweConst.SEFLG_SPEED, ls, serr) == SweConst.ERR)
        return SweConst.ERR;
      if (sw.swe_calc(t, SweConst.SE_MOON, iflag | SweConst.SEFLG_SPEED, lm, serr) == SweConst.ERR)
        return SweConst.ERR;
...
//next_try:
  ...
  private int occult_when_loc(double tjd_start, int ipl, StringBuffer starname, int ifl, double[] geopos, double[] tret, double[] attr, int backward, StringBuffer serr) {
    ...
    while (true) {
//next_try:
      if (calc_planet_star(t, ipl, starname, iflaggeo | SweConst.SEFLG_SPEED, ls, serr) == SweConst.ERR)
        return SweConst.ERR;
      if (sw.swe_calc(t, SweConst.SE_MOON, iflaggeo | SweConst.SEFLG_SPEED, lm, serr) == SweConst.ERR)
        return SweConst.ERR;
      dtv = lm[3] - ls[3]; /* difference in speed */
      dctr.val = sl.swe_degnorm(ls[0] - lm[0]);
      if (backward!=0) 
...
//next_try:
  ...
  * @see org.athomeprojects.swisseph.SweConst#OK
  * @see org.athomeprojects.swisseph.SweConst#ERR
  * @see org.athomeprojects.swisseph.SweConst#SEFLG_JPLEPH
  * @see org.athomeprojects.swisseph.SweConst#SEFLG_SWIEPH
  * @see org.athomeprojects.swisseph.SweConst#SEFLG_MOSEPH
  * @see org.athomeprojects.swisseph.SweConst#SEFLG_TRUEPOS
  * @see org.athomeprojects.swisseph.SweConst#SEFLG_HELCTR
  */
  ...
  * @see org.athomeprojects.swisseph.SweConst#SEFLG_SWIEPH
  * @see org.athomeprojects.swisseph.SweConst#SEFLG_MOSEPH
  * @see org.athomeprojects.swisseph.SweConst#SE_CALC_RISE
  * @see org.athomeprojects.swisseph.SweConst#SE_CALC_SET
  * @see org.athomeprojects.swisseph.SweConst#SE_CALC_MTRANSIT
  * @see org.athomeprojects.swisseph.SweConst#SE_CALC_ITRANSIT
  * @see org.athomeprojects.swisseph.SweConst#SE_BIT_DISC_CENTER
  * @see org.athomeprojects.swisseph.SweConst#SE_BIT_NO_REFRACTION
  * @see org.athomeprojects.swisseph.DblObj
  */
  ...
  For org.athomeprojects.moira, note that this is a simplification and
  idealization.
  ...
  org.athomeprojects.moira is used to.
  ...
  */
  int swe_nod_aps(double tjd_et, int ipl, int iflag,
    ...
    double[] xna = xx, xnd = xx, xpe = xx, xap = xx;
    ...
    Epsilon oe;
    boolean is_true_nodaps = false, is_mean_nodaps = false;
...
//      sm.swi_mean_lunar_elements(tjd_et, &xna[0], &xna[3], &xpe[0], &xpe[3]);
  ...
  * @see org.athomeprojects.swisseph.SweConst#OK
  * @see org.athomeprojects.swisseph.SweConst#ERR
  * @see org.athomeprojects.swisseph.SweConst#SE_NODBIT_MEAN
  * @see org.athomeprojects.swisseph.SweConst#SE_NODBIT_OSCU
  * @see org.athomeprojects.swisseph.SweConst#SE_NODBIT_OSCU_BAR
  * @see org.athomeprojects.swisseph.SweConst#SE_NODBIT_FOPOINT
  */
